...
namespace quicksdk
{
	...
	public class QuickSDKImp
	{
		...
		{
#if UNITY_IOS && !UNITY_EDITOR && QUICKSDK_IOS_PLUGIN
        ...
        {
#if UNITY_IOS && !UNITY_EDITOR && QUICKSDK_IOS_PLUGIN
            quicksdk_nativeShowGameCustomPrivacyView(true);
#elif UNITY_ANDROID && !UNITY_EDITOR
            QuickUnitySupportAndroid androidSupport = QuickUnitySupportAndroid.getInstance();
        ...
        {
#if UNITY_IOS && !UNITY_EDITOR && QUICKSDK_IOS_PLUGIN
            IntPtr intPtr = quicksdk_nativeGetParentChannelType();
            return Marshal.PtrToStringAnsi(intPtr) ?? "";
#elif UNITY_ANDROID && !UNITY_EDITOR
			QuickUnitySupportAndroid androidSupport = QuickUnitySupportAndroid.getInstance();
		...
		[DllImport("__Internal")]
		private static extern IntPtr quicksdk_nativeGetParentChannelType();
		[DllImport("__Internal")]
        ...
        [DllImport("__Internal")]
        private static extern void quicksdk_nativeShowGameCustomPrivacyView(bool must);
        [DllImport("__Internal")]
        private static extern void quicksdk_nativeExitGame();
#endif
