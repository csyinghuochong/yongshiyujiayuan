...
namespace I2.Loc
{
	...
	public partial class LocalizeInspector : Editor
	{
		...
		void OnGUI_Target()
		{
			...
			TestTargetType<Text>		( ref TargetTypes, "GUIText", ref CurrentTarget );
			...
			TestTargetType<Image>	( ref TargetTypes, "GUITexture", ref CurrentTarget );
			...
			if (GUI.changed)
			{
				...
				{
					case "GUIText" 				:  mLocalize.mTarget = mLocalize.GetComponent<Text>(); break;
					...
					case "GUITexture" 			:  mLocalize.mTarget = mLocalize.GetComponent<Image>(); break;
