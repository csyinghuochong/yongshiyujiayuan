...
public class UI_HuoDongRewardShiLiList : MonoBehaviour
{
    ...
    public void updataDengLuReward() {
        ...
        //显示标题
        string langStr = Game_PublicClassVar.Get_gameSettingLanguge.LoadLocalization("需要战力达到");
    ...
    {
        //判定当前等级是否大于12级
        int roseShiLi = Game_PublicClassVar.Get_game_PositionVar.Obj_Rose.GetComponent<Rose_Proprety>().Rose_ShiLiValue;
        if (roseShiLi < 1000)
        {
            string langStrHint = Game_PublicClassVar.Get_gameSettingLanguge.LoadLocalizationHint("hint_344");
            Game_PublicClassVar.Get_function_UI.GameGirdHint_Front(langStrHint);
            //Game_PublicClassVar.Get_function_UI.GameHint("请将实力提升至对应值后领取!");
            return;
        }

        //判定人数
        if (RewardNum_Now >= RewardNum_Sum) {
            string langStrHint = Game_PublicClassVar.Get_gameSettingLanguge.LoadLocalizationHint("hint_345");
            Game_PublicClassVar.Get_function_UI.GameGirdHint_Front(langStrHint);
        ...
        */
        ...
        Pro_ComStr_4 pro_ComStr_4 = new Pro_ComStr_4() { str_1= zhanghaoID, str_2 = "2",str_3 = RewardSonType, str_4 = roseShiLi.ToString()};
