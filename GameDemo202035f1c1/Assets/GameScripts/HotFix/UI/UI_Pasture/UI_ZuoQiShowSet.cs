...
public class UI_ZuoQiShowSet : MonoBehaviour {
    ...
    public void Init() {
        ...
        if (nowLv == "0" || nowLv == "")
        {
            ...
            object obj = ResourcesManager.Instance.LoadIconSync<Sprite>("GameUI/Img/ZuoQiJieDuanLv_" + nowLv);
        ...
        if (Obj_ZuoQiImgShow != null)
        {
            ...
            object obj = ResourcesManager.Instance.LoadTextureSync<Texture>("CameraImage/ZuoQi_" + nowZuoQiShowID);
