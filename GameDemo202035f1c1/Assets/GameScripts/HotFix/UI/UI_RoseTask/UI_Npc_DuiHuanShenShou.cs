...
public class UI_Npc_DuiHuanShenShou : MonoBehaviour {
    ...
    public void Btn_DuiHuanShenShou() {
        ...
        string langStrHint = LanguageManager.Instance.LoadLocalizationHint("comhint_2");
    ...
    public void DuiHuanShenShou() {
        ...
        if (nullPetNum == -1)
        {
            string langStrHint = LanguageManager.Instance.LoadLocalizationHint("hint_5");
        ...
        if (itemNum >= 100)
        {
            if (Game_PublicClassVar.Get_function_Rose.CostBagItem("10010087", 100)) {
                ...
                string langStrHint = LanguageManager.Instance.LoadLocalizationHint("hint_6");
                Game_PublicClassVar.Get_function_UI.GameGirdHint_Front(langStrHint);
                //Game_PublicClassVar.Get_function_UI.GameGirdHint_Front("恭喜你获得传说神兽!!!");
            }
        }
        else {
            string langStrHint = LanguageManager.Instance.LoadLocalizationHint("hint_7");
            Game_PublicClassVar.Get_function_UI.GameGirdHint_Front(langStrHint);
