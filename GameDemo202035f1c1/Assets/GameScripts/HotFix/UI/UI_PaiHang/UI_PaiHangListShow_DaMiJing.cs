...
public class UI_PaiHangListShow_DaMiJing : MonoBehaviour {
    ...
    public string roseDaMiJingLvValue;
    public float roseDaMiJingLvTime;
    ...
    public GameObject Obj_RoseDaMiJingLvValue;
    public GameObject Obj_RoseDaMiJingTime;
    ...
    public void ShowPlayListData() {
        ...
        if (IfNullStatus == true) {
            ...
            Obj_RoseDaMiJingLvValue.GetComponent<Text>().text = "0";
            Obj_RoseDaMiJingTime.GetComponent<Text>().text = "0";
        ...
        Obj_RoseDaMiJingLvValue.GetComponent<Text>().text = roseDaMiJingLvValue;
        int showMin = (int)(roseDaMiJingLvTime / 60);
        int showSec = (int)(roseDaMiJingLvTime - showMin * 60);
        string showTimeStr = "";
        if (showMin >= 1) {
            showTimeStr = showMin + "分";
        }
        if (showSec >= 1) {
            showTimeStr = showTimeStr + showSec +  "秒";
        }
        Obj_RoseDaMiJingTime.GetComponent<Text>().text = showTimeStr;
