        ...
        if (skillID != "" && skillID != "0")
        {
            ...
            switch (lastID)
            {
                case "1":
                    ...
                    object obj = ResourcesManager.Instance.LoadIconSync<Sprite>("ItemIcon/" + skillIconID);
                ...
                case "6":
                    ...
                    obj = ResourcesManager.Instance.LoadIconSync<Sprite>("SkillIcon/" + skillIcon);
        ...
        */
        ...
        if (skillID.Substring(0, 1) == "1")
        {
            ...
            if (skillIcon != "0")
            {
                ...
                //显示Icon
                object obj = ResourcesManager.Instance.LoadIconSync<Sprite>("ItemIcon/" + skillIcon);
