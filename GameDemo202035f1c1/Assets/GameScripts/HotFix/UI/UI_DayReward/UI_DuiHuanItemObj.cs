...
public class UI_DuiHuanItemObj : MonoBehaviour
{
    ...
    public void Btn_Buy() {
        if (!ifshow) {
            ...
            string langStrHint = LanguageManager.Instance.LoadLocalizationHint("hint_238");
        ...
        if (bagNum < 1)
        {
            string langStrHint = LanguageManager.Instance.LoadLocalizationHint("hint_239");
            Game_PublicClassVar.Get_function_UI.GameGirdHint_Front(langStrHint);
        ...
        if (Game_PublicClassVar.Get_function_Rose.CostReward("3", buyPrice)) {
            //发送道具
            Game_PublicClassVar.Get_function_Rose.SendRewardToBag(ItemID, 1, "0", 0, "0", true, "36");
            //更新任务
        ...
        {
            //兑换失败
            string langStrHint = LanguageManager.Instance.LoadLocalizationHint("hint_240");
            Game_PublicClassVar.Get_function_UI.GameGirdHint_Front(langStrHint);
