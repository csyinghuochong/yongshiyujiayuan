...
public class RoseSkill_Sing_1 : MonoBehaviour
{
    ...
    private void ShowZhishiEffect()
    {
        ...
        if (SelectSkillRangeType == "1")
        {
            ...
            //实例化选中特效
            SkillSelectRangeEffect = ResourcesManager.Instance.LoadEffectSync<GameObject>("Rose/Rose_SelectRange");        //实例化范围特效
            ...
            //实例化玩家释法范围
            GameObject skillRangeEffect = ResourcesManager.Instance.LoadEffectSync<GameObject>("Rose/Rose_SkillRange");        //实例化范围特效
