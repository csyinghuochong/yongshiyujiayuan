                ...
                case "1":
                    ...
                    if (collider.gameObject.GetComponent<AI_1>() != null)
                    {
                        if (effectName != "0")
                        {
                            ...
                            collider.GetComponent<AI_1>().HitEffect = (GameObject)ResourcesManager.Instance.LoadEffectSync<GameObject>("Skill/" + effectName);
                        }
                    ...
                    if (collider.gameObject.GetComponent<AIPet>() != null)
                    {
                        ...
                        {
                            effectName = "Eff_Hit_Fire_3";
                            collider.GetComponent<AIPet>().HitEffect = (GameObject)ResourcesManager.Instance.LoadEffectSync<GameObject>("Skill/" + effectName);
                        }
