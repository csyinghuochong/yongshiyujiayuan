...
public class UpdateSetting : ScriptableObject
{
    ...
    /// </summary>
    [Header("WebGL设置")] [SerializeField] private LoadResWayWebGL LoadResWayWebGL = LoadResWayWebGL.Remote;
    ...
    /// 打包程序资源地址
    /// </summary>
    [SerializeField] private string BuildAddress = "../../Builds/Unity_Data/StreamingAssets";
