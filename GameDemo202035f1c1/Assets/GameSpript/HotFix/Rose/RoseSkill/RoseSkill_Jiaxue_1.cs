            ...
            switch (skillParValue[0]) { 
                ...
                case "1":
                    switch (skillParValue[1]) {
                        //最大生命值
                        case "1":
                            hudunValue = (int)(Game_PublicClassVar.Get_game_PositionVar.Obj_Rose.GetComponent<Rose_Proprety>().Rose_Hp * float.Parse(skillParValue[2]) * (1 + Game_PublicClassVar.Get_game_PositionVar.Obj_Rose.GetComponent<Rose_Proprety>().Rose_HuDunValueAddPro));
                        break;
                        //最大攻击
                        case "2":
                            hudunValue = (int)(Game_PublicClassVar.Get_game_PositionVar.Obj_Rose.GetComponent<Rose_Proprety>().Rose_ActMax * float.Parse(skillParValue[2]) * (1 + Game_PublicClassVar.Get_game_PositionVar.Obj_Rose.GetComponent<Rose_Proprety>().Rose_HuDunValueAddPro));
                        break;
                    }
                    ...
                    if (Game_PublicClassVar.Get_game_PositionVar.Obj_Rose.GetComponent<Rose_Proprety>().HuDunEffect != null)
                    {
