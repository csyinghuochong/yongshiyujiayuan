...
public class UI_SizeEffect_2 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        float now_x = posi_x_1 + (posi_x_2 - posi_x_1) * sizeTimeSum;
        this.gameObject.transform.localPosition = new Vector3(now_x, this.transform.localPosition.y, this.transform.localPosition.z);
    }
}
