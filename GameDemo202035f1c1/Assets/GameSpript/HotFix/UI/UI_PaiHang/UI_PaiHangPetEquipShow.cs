...
public class UI_PaiHangPetEquipShow : MonoBehaviour {
    ...
    public string PaihangPetEquipHideStr;
        ...
        if (obj_ItemTips == null)
        {
            ...
            if (EquipType == 2)
            {
                ...
                if (Game_PublicClassVar.Get_game_PositionVar.Obj_UI_FunctionOpen.GetComponent<UI_FunctionOpen>().Obj_rosePet != null)
                {
                    ...
                    //obj_ItemTips.GetComponent<UI_EquipTips>().ItemHideID = hideID;
                    /*
                    if (PaihangPetEquipHideStr != "")
                    {
                        obj_ItemTips.GetComponent<UI_EquipTips>().ItemHide_PaiHangBangShowHideStr = PaihangPetEquipHideStr;
                    }
                    */
                }
