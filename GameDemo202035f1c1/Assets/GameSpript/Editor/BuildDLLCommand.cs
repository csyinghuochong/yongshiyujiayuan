...
public static class BuildDLLCommand
{
    ...
    public static void CopyAOTAssembliesToAssetPath()
    {
        ...
        string aotAssembliesDstDir = Application.dataPath +"/"+ Init.UpdateSetting.AssemblyTextAssetPath;

        foreach (var dll in Init.UpdateSetting.AOTMetaAssemblies)
        {
    ...
    public static void CopyHotUpdateAssembliesToAssetPath()
    {
        ...
        string hotfixAssembliesDstDir = Application.dataPath +"/"+ Init.UpdateSetting.AssemblyTextAssetPath;
