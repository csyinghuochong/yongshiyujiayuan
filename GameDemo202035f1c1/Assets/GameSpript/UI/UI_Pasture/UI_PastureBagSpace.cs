...
public class UI_PastureBagSpace : MonoBehaviour
{

    public ObscuredString BagPosition;                  //背包位置
    ...
    public ObscuredBool UpdataItemShow;                 //更新道具显示
    private ObscuredString ItemID;                      //道具ID
    private ObscuredString ItemNum;                     //道具数量
    private ObscuredString ItemIcon;                    //道具Icon
    private ObscuredString ItemQuality;                 //道具品质
    ...
    public ObscuredBool MoveBagStatus = true;           //移动背包状态是否开启  True可以上下移动背包格子位置,不是移动道具图标
    private ObscuredFloat lastMovePosition_Y;           //上一次Y坐标
    private Function_DataSet function_DataSet;
    private ObscuredString lastItemID;                  //上一次道具ID
    public GameObject Obj_ItemPinZhi;
	...
	void Update () {
        ...
        if (game_positionVar.UpdatePastureBagAll) {
    ...
    void updateItem() {
        ...
        if (ItemID != "0")
        {
            ...
            ItemNum = function_DataSet.DataSet_ReadData("ItemNum", "ID", BagPosition, "RosePastureBag");
            //显示道具数量
            ...
            //显示道具品质
            if (Obj_ItemPinZhi != null)
            {
                Obj_ItemPinZhi.SetActive(true);
                string nowItemPar = function_DataSet.DataSet_ReadData("ItemPar", "ID", BagPosition, "RosePastureBag");
                Obj_ItemPinZhi.GetComponent<Text>().text = "品:" + nowItemPar;
            }
            ...
            if (Obj_ItemPinZhi != null) {
                Obj_ItemPinZhi.SetActive(false);
            }
        }
	...
	public void Mouse_Down(){
        ...
        */
        ...
        if (Game_PublicClassVar.Get_game_PositionVar.Obj_PastureHeChengSet_Open!=null&& Game_PublicClassVar.Get_game_PositionVar.Obj_PastureHeChengSet_Open.active==true) {
            Game_PublicClassVar.Get_game_PositionVar.Obj_PastureHeChengSet_Open.GetComponent<UI_PastureHeChengSet>().PutSpaceID(BagPosition);
            return;
        }
        ...
        if (Game_PublicClassVar.Get_game_PositionVar.Obj_PastureNpcBuySet_Open != null&& Game_PublicClassVar.Get_game_PositionVar.Obj_PastureNpcBuySet_Open.active == true) {
            Game_PublicClassVar.Get_game_PositionVar.Obj_PastureNpcBuySet_Open.GetComponent<UI_PastureNpcBuySet>().PutSpaceID(BagPosition);
            return;
        }
        ...
        {
            Game_PublicClassVar.Get_game_PositionVar.Obj_ZuoQiJiHuoSet_Open.GetComponent<UI_ZuoQiXianJiSet>().PutSpaceID(BagPosition);
            return;
        }


        //坐骑献祭
        if (Game_PublicClassVar.Get_game_PositionVar.Obj_ZuoQiWeiShiSet_Open != null && Game_PublicClassVar.Get_game_PositionVar.Obj_ZuoQiWeiShiSet_Open.active == true)
        {
            Game_PublicClassVar.Get_game_PositionVar.Obj_ZuoQiWeiShiSet_Open.GetComponent<UI_ZuoWeiShiSet>().PutSpaceID(BagPosition);
            return;
        }
        ...
        if (ItemID != "0")
        {
            ...
            if (obj_ItemTips == null)
            {
                ...
                else
                {
                    ...
                    obj_ItemTips.GetComponent<UI_ItemTips>().EquipTipsType = "9";
					//回收界面打开
                    if (Game_PublicClassVar.Get_game_PositionVar.HuiShouItemStatus)
                    {
                    ...
                    //家园仓库
                    if (Game_PublicClassVar.Get_game_PositionVar.Obj_UI_FunctionOpen.GetComponent<UI_FunctionOpen>().RosePastureBag_Status&& Game_PublicClassVar.Get_game_PositionVar.Obj_UI_FunctionOpen.GetComponent<UI_FunctionOpen>().Obj_RosePastureBag!=null) {
                        obj_ItemTips.GetComponent<UI_ItemTips>().EquipTipsType = "10";
                    }
                }
            }
            else
