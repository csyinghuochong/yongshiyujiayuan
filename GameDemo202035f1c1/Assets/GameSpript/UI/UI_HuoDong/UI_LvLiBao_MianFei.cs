...
public class UI_LvLiBao_MianFei : MonoBehaviour
{
    ...
    public void ChuShiHua() {
        ...
        MeiRiLiBaoStr = Game_PublicClassVar.Get_function_DataSet.DataSet_ReadData("Value", "ID", "LvLiBao_MianFei", "GameMainValue");
