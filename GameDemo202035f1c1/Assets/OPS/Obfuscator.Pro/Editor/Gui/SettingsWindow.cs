...
namespace Obfuscator.Gui
{
    public class SettingsWindow : EditorWindow
    {
            ...
            public static Font Candara
            {
                get
                {
                    if (candara == null)
                    {
                        try
                        {
                            candara = (Font)EditorGUIUtility.Load("Assets/OPS/Obfuscator.Pro/Editor/Gui/Font/Candara.ttf");
                        }
                        catch (Exception e)
                        {
            ...
            public static Font CandaraBold
            {
                get
                {
                    if (candaraBold == null)
                    {
                        try
                        {
                            candaraBold = (Font)EditorGUIUtility.Load("Assets/OPS/Obfuscator.Pro/Editor/Gui/Font/Candara_Bold.ttf");
                        }
                        catch (Exception e)
                        {
                            Debug.LogError(e.ToString());
        ...
        private int activeOptions
        {
            get
            {
                return (this.settings.AddRandomCode ? 1 : 0)
                    + (this.settings.MakeAssemblyTypesUnreadable ? 1 : 0)
                    ...
                    case 1:
                        {
                            ...
                            this.settings.MakeAssemblyTypesUnreadable = false;
                    ...
                    case 3:
                        {
                            ...
                            {
                                this.settings.AddRandomCode = false;
                                this.settings.MakeAssemblyTypesUnreadable = true;
        ...
        [MenuItem("Window/Obfuscator Pro Settings")]
        ...
        private void AdvancedTab()
        {
            ...
            Table.Gui("Obfuscate:", "Private", "Protected", "Public", ref this.settings.ObfuscateClassPrivate, ref this.settings.ObfuscateClassProtected, ref this.settings.ObfuscateClassPublic);

            EditorGUILayout.HelpBox("Obfuscation of serializeable classes and members will make problems if you are trying to deserialize/load data that got obfuscated with different names! So use the Save Mapping setting.", MessageType.Warning);
            ...
            Table.Gui("Obfuscate:", "Private", "Protected", "Public", ref this.settings.ObfuscateFieldPrivate, ref this.settings.ObfuscateFieldProtected, ref this.settings.ObfuscateFieldPublic);
            ...
            Table.Gui("Obfuscate:", "Private", "Protected", "Public", ref this.settings.ObfuscateMethodPrivate, ref this.settings.ObfuscateMethodProtected, ref this.settings.ObfuscateMethodPublic);
        ...
        private void SecurityTab()
        {
            ...
            {
                OPS.Obfuscator.Process.Pro.RsaHelper.GenerateNewKeys();
            }
            ...
            Row.GuiGold("Unreadability for Decompilers: ", ref this.settings.MakeAssemblyTypesUnreadable);
